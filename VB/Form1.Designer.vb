...
Namespace DayHeaderStatistics
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.schedulerControl1.Start = New System.DateTime(2007, 8, 10, 0, 0, 0, 0)
...
'			Me.schedulerControl1.CustomDrawDayViewAllDayArea += New DevExpress.XtraScheduler.CustomDrawObjectEventHandler(Me.schedulerControl1_CustomDrawDayViewAllDayArea);
			' 
			' Form1
			' 
